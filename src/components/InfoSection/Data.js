export const homeObjOne = {
    ...
    lightTextDesc : true,
    topLine: 'WaffleNFT',
    headLine: 'A Unique Collection of Scrumptious Waffles',
    ...
    imgStart: false,
    img: require('../../images/about-hero.png').default,
    alt: 'Car',
    dark: true,
    primary: true,
    darkText: false,
...
export const homeObjTwo = {
    ...
    lightTextDesc : false,
    topLine: 'CryptoSim',
    headLine: 'Create your own Sim and breed it with other Sims',
    description: "CryptoSim are NFT Collection programmed to breed with each other producing NFT Children that inherits their NFT Parents attributes. ",
    buttonLabel: 'Learn More',
    imgStart: true,
    img: require('../../images/cryptosim.svg').default,
    alt: 'Piggybank',
    dark: false,
    primary: false,
    darkText: true,
